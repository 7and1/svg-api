/**
 * OpenAPI 3.1 Specification for SVG API
 *
 * This file exports the complete OpenAPI specification for all API endpoints.
 * It can be served as JSON or used to generate documentation.
 *
...
## Cache Headers
All responses include cache headers to optimize client-side caching.`,
    contact: {
      name: "SVG API",
      url: "https://svg-api.org",
      email: "noreply@svg-api.org",
    },
    license: {
      name: "MIT",
                  ...
                  data: [
                    {
                      ...
                      category: "navigation",
                      tags: ["home", "house"],
                      svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>',
                      variants: ["default"],
                      license: {
                        type: "ISC",
                        url: "https://github.com/lucide-icons/lucide/blob/main/LICENSE",
                  ...
                  data: [
                    {
                      ...
                      score: 2.0,
                      preview_url:
                        "https://svg-api.org/v1/icons/arrow-right?source=lucide",
                      matches: { name: true, tags: ["arrow"] },
                    },
                  ],
                  meta: {
                    query: "arrow",
                  ...
                  data: [
                    {
                      ...
                      categories: ["arrows", "navigation", "ui", "etc."],
                    },
                  ],
                  meta: { total_sources: 7, total_icons: 22000 },
                },
              },
            },
          },
    ...
    "/v1/random": {
      get: {
        ...
        responses: {
              ...
              "application/json": {
                ...
                example: {
                  data: {
                    ...
                    preview_url:
                      "https://svg-api.org/v1/icons/star?source=lucide",
                  },
                  meta: {
                    request_id: "req_1234567890",
                    timestamp: "2024-01-01T00:00:00.000Z",
          ...
          "404": {
            description: "No icons found for filters",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
              },
  ...
  components: {
    ...
    securitySchemes: {
      rateLimit: {
        ...
        in: "header",
        name: "X-Rate-Limit",
        description: "Rate limit headers are automatically handled by the API",
      },
    },
  },
};
...
/**
 * Gets the OpenAPI spec as a JSON string
 */
